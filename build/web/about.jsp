        ...
        <div class="img-aboutus">
            ...
            <div class="container-intro-aboutus">
                <div class="post-entry-aboutus">
                    ...
                    <p>Welcome to our Koi Care Management System! We are dedicated to helping you maintain environment for your Koi fish. 
                        Our team of experts is passionate about providing you with the best tools and resources for effective pond and fish management. 
                        Whether you’re tracking water quality, enhancing the well-being of your Koi fish</p>
                </div>
            ...
            <div class="container">
                <div class="item-desc-intro">
                    <div class="img-first" data-aos="fade-in" data-aos-delay="100">
                        <img src="https://www.kodamakoifarm.com/wp-content/uploads/2024/10/koi-fish-vs-carp-1-2.jpg" alt="">
                    </div>
                    <div class="text-desc">
                        <h2 class="">Koi Care System</h2>
                        <p class="">Our Koi Care Management System is designed to help you maintain  fish pond for your Koi fish. We provide tools and resources to track water quality, feeding amount for each fish.</p>
                        <p><a href="#" class="btn-read btn btn-outline-secondary py-2">Learn more</a></p>
                    </div>
                </div>

                <div class="item-desc-intro">
                    <div class="img-first img-first-secondchild" data-aos="fade-in" data-aos-delay="100">
                        <img src="https://cdn11.bigcommerce.com/s-m39bqdjce8/images/stencil/1280x1280/uploaded_images/how-big-will-your-koi-fish-grow.jpg?t=1700625739" alt="">
                    </div>
                    <div class="text-desc text-first-secondchild">
                        <h2>Koi Pond Maintenance</h2>
                        <p>Discover essential tips for maintaining your Koi pond. From water quality monitoring to appropriate feeding practices, our system supports you in creating an optimal environment for your Koi.</p>
                        <p><a href="#" class="btn-read btn btn-outline-secondary py-2">Learn more</a></p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
                        <div class="feature d-flex">
                            ...
                            <div class="desc-potential">
                                ...
                                <p>Provide your Koi with the best nutrition tailored to their growth stages. Our system offers recommendations for high-quality feed.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="feature d-flex">
                            <span class="icon-potential"><i class="fa-solid fa-triangle-exclamation"></i></span>
                            <div class="desc-potential">
                                <h3>Timely Alerts</h3>
                                <p>Receive notifications about water quality issues or fish issues.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                        <div class="feature d-flex">
                            ...
                            <div class="desc-potential">
                                ...
                                <p>Manage your Koi pond efficiently without breaking the bank. Our tools help you keep track of expenses while ensuring the best care for your fish.</p>
                            </div>
                        </div>
                    </div>
                </div>
