<%-- 
    Document   : manageFishDetails
    Created on : Oct 6, 2024, 11:16:49 PM
    Author     : ASUS
--%>
                        ...
                        <div class="fish-container">
                            <form>
                                ...
                                <div class="button-container">
                                    <button type="button" class="btn btn-secondary" onclick="window.location.href = 'manageFish.jsp'">Back</button>
                                </div>
                            </form>
                        </div>
                    </div>
