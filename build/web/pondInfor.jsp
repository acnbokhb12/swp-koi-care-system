        ...
        <div class="container container_pond">
            ...
            <div class="row mt-4">
                ...
                <div class="col-8 info">
                    <div class="info-item">
                        <span class="label">Pond Name:</span> 
                        <span class="value">${pond.name}</span>
                    </div>
                    <div class="info-item">
                        <span class="label">Depth:</span> 
                        <span class="value">${pond.depth}m</span>
                    </div>
                    <div class="info-item">
                        <span class="label">Volume:</span> 
                        <span class="value">${pond.volume} liters</span>
                    </div>
                    <div class="info-item">
                        <span class="label">Drain Count:</span> 
                        <span class="value">${pond.drainCount}</span>
                    </div>
                    <div class="info-item">
                        <span class="label">Pump Power:</span> 
                        <span class="value">${pond.pumpPower}HP</span>
                    </div>
                </div>
            </div>
