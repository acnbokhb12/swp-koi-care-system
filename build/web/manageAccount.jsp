                                ...
                                <c:forEach var="acc" items="${listAcc}">
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="#" class="btn-delete-acc text-danger" data-userid="${acc.userID}"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        ...
                        <div class="col-4">
                            <div class="img-add-submit">
                                <div class="img-info-add">
                                    <img id="imagePreview" src="https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lq2v9pw1pdci29.webp" alt="Koi Pond" class="account-image">
                                </div>
        ...
        <script>
            ...
            $('.btn-delete-acc').click(function (e) {
                ...
                if (confirmation) {
                    ...
                    window.location.href = "AdminAccountController?action=delete&userID=" + userId;
                }
            });
        </script>
    </div>
