                ...
                <div class="right-navbar-admin-manage"> 
                    <div class="content">
                        ...
                        <div class="content__news-main">
                            ...
                            <form action="MainController?action=createNews" method="post" id="fomr_fill-news" enctype="multipart/form-data">
                                ...
                                <div class="desc-tile-news"> 
                                    ...
                                    <input type="file" id="imageInput" accept="image/*" name="fileimg">
                                </div>
                                <img id="imagePreview"  src="${NewsImage}" alt="" >
                                <div class="desc-tile-news"> 

                                    <label for="category">Category:</label>
                                    <select name="newsCategoryID" id="category">
                                        <c:forEach var="category" items="${ListNC}">
                                            <option value="${category.id}">${category.name}</option>
                                        </c:forEach>
                                    </select>

                                </div>
                                <textarea id="mytextarea-news" name="NewsDescription"></textarea>
