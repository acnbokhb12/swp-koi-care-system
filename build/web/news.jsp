                    ...
                    <div class="row">
                            ...
                            <div class="trending-top">
                                <a href="newsDetail.jsp" class="trending-top-img">
                                    ...
                                    <div class="trending-top-cap">
                                        ...
                                        <h2>Super September - Garden Supplies Extras</h2>
                                    </div>
                                </a>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-lg-4">
                                        <a href="newsDetail.jsp" class="trending-bottom-single">
                                            ...
                                            <div class="trending-bottom-cap">
                                                <span>Lifestyple</span>
                                                <h4>Get the Illusion of Fuller Lashes by “Mascng fsfsafewas.”</h4>
                                            </div>
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <a href="newsDetail.jsp" class="trending-bottom-single">
                                            ...
                                            <div class="trending-bottom-cap">
                                                <span>Lifestyple</span>
                                                <h4>Get the Illusion of Fuller Lashes by “Mascngds asd asd dsa.”</h4>
                                            </div>
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <a href="newsDetail.jsp" class="trending-bottom-single">
                                            ...
                                            <div class="trending-bottom-cap">
                                                <span>Lifestyple</span>
                                                <h4>Get the Illusion of Fuller Lashes by “Mascng.”</h4>
                                            </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <a href="" class="trend-right-single d-flex">
                                <div class="tren-right-img">
                                    <img src="https://buyamericankoifish.com/wp-content/uploads/2020/03/DSC_0570.jpg" alt="">
                                </div>
                                <div class="trend-rigth-cap">
                                    <span>sea beach</span>
                                    <h4>Welcome To The Best Model Winner Contest</h4>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="news-title-section">
                                <h4 class="m-0 text-uppercase">Featured News</h4> 
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="swiper-wrapper container__news-list">
                                <div class="container__news-item swiper-slide">
                                    <a href="" class="container__news-item-desc">
                                        <img src="https://themewagon.github.io/biznews/img/news-700x435-1.jpg" alt="">
                                        <div class="container__news-item-cap">
                                            <div class="news-item-cap-detail">
                                                <span>Medicine</span>
                                                <p>Jan 01, 2045</p>
                                            </div>
                                            <h4>Lorem ipsum dolor sit amet elit fdsf asdf asfas  dsf sadfas dfasfsdafsad</h4>
                                        </div>
                                    </a>
                                </div>
                                <div class="container__news-item swiper-slide">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <a href="#" class="item__news__link position-relative">
                                    <img class="img-fluid w-100" src="https://img-s-msn-com.akamaized.net/tenant/amp/entityid/AA1hpKmi.img?w=768&h=430&m=6" alt="">
                                    <div class="news-item-continuous bg-white border border-top-0 ">
                                        ...
                                        <h2 class="item-continuous-title">Lorem ipsum dolor sit amet elit sf asf sayu af asasd</h2>
                                        <p class="item-continuous-description">
                                            Annual Fresno Koi Show features top koi fish; IndiGo flight passengers exchange threats KOI KOI restaurant acquisition dispute.
                                        </p>
                                    </div>
                                </a> 
                            </div>
