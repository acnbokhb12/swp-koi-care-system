...
static {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("\n");
      out.write("                        <!-- Form for searching by Status -->\n");
      out.write("                        <form id=\"searchByStatusForm\" action=\"ManagerOrderSearchByOrderStatusController\" method=\"POST\" class=\"table-search-form row gx-1 align-items-center\" style=\"display: none;\">\n");
      out.write("                            <div class=\"contain-btn-select-order\">\n");
      out.write("                                <select class=\"contain-btn-select-search\" name=\"status\" id=\"status\" required>\n");
      out.write("                                    ");
      ...
      out.write("        return confirm(\"Are you sure you want to delete this order?\");\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    function showSearchByCustomerName() {\n");
      out.write("        document.getElementById('searchByCustomerNameForm').style.display = 'block';\n");
      out.write("        document.getElementById('searchByOrderDateForm').style.display = 'none';\n");
      out.write("        document.getElementById('searchByStatusForm').style.display = 'none';\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    function showSearchByOrderDate() {\n");
      out.write("        document.getElementById('searchByCustomerNameForm').style.display = 'none';\n");
      out.write("        document.getElementById('searchByOrderDateForm').style.display = 'block';\n");
      out.write("        document.getElementById('searchByStatusForm').style.display = 'none';\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    function showSearchByStatus() {\n");
      out.write("        document.getElementById('searchByCustomerNameForm').style.display = 'none';\n");
      out.write("        document.getElementById('searchByOrderDateForm').style.display = 'none';\n");
      out.write("        document.getElementById('searchByStatusForm').style.display = 'block';\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    document.getElementById(\"searchByOrderDateForm\").addEventListener(\"submit\", function (event) {\n");
      ...
      out.write("\n");
      out.write("        const start = new Date(startDate);\n");
      out.write("        const end = new Date(endDate);\n");
      out.write("\n");
      out.write("        if (start > end) {\n");
      out.write("            event.preventDefault();\n");
      out.write("            alert(\"From Date should be earlier than or the same as End Date.\");\n");
      out.write("        }\n");
      out.write("    });\n");
      out.write("</script>\n");
      out.write("<script src=\"./assets/js/notification.js\"></script>\n");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${status.orderStatusID}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" \n");
          out.write("                                                ");
          ...
          out.write("\n");
          out.write("                                                >");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${status.orderStatusName}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</option>\n");
          out.write("                                    ");
  ...
  private boolean _jspx_meth_c_if_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_if_0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${status.orderStatusID == OrderStatus}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("</td>\n");
          out.write("                                        <td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${order.customerName}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</td>\n");
          out.write("                                        <td>\n");
          out.write("                                            ");
          ...
          out.write("\n");
          out.write("                                            ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${formattedTime}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write(" \n");
          out.write("                                        </td>\n");
          out.write("\n");
          out.write("                                        <td class=\"order-status \n");
          out.write("                                            ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${order.orderS.orderStatusID == 1 ? 'order-pending' : \n                                              order.orderS.orderStatusID == 2 ? 'order-processing' : \n                                              order.orderS.orderStatusID == 3 ? 'order-completed' : ''}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\">\n");
          out.write("                                                ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${order.orderS.orderStatusName}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\n");
          out.write("                                            </td>\n");
          out.write("\n");
          out.write("                                            <td>    \n");
          ...
          out.write("                                            </td>\n");
          out.write("                                            <td>\n");
          out.write("                                                <a href=\"MainController?action=managerorderdetails&orderId=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${order.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" class=\"edit-btn\">\n");
          out.write("                                                    <i class=\"fas fa-edit\"></i>\n");
          out.write("                                                </a>\n");
          out.write("                                                <a href=\"MainController?action=managerorderdelete&orderId=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${order.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" \n");
          out.write("                                                   class=\"text-danger delete-btn\" \n");
          out.write("                                                   onclick=\"return confirmDelete();\">\n");
          out.write("                                                    <i class=\"fas fa-trash\"></i>\n");
          out.write("                                                </a>\n");
          out.write("                                            </td>\n");
          out.write("                                            <td>\n");
          out.write("                                                <form action=\"ManagerChangeOrderStatusController\" method=\"POST\">\n");
          ...
          out.write("\">\n");
          out.write("                                                    <input type=\"hidden\" name=\"newStatus\" \n");
          out.write("                                                           value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${order.orderS.orderStatusID == 1 ? 2 : (order.orderS.orderStatusID == 2 ? 3 : '')}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\">\n");
          out.write("                                                    <button type=\"submit\" class=\"confirm-btn\" \n");
          out.write("                                                            ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${order.orderS.orderStatusID == 3 ? 'disabled' : ''}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write(">\n");
  ...
  private boolean _jspx_meth_c_set_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_c_set_0.setVar("orderDate");
    _jspx_th_c_set_0.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${order.orderDate}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_set_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_c_set_1.setVar("formattedDate");
    _jspx_th_c_set_1.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${fn:substring(orderDate, 0, 10)}", java.lang.Object.class, (PageContext)_jspx_page_context, _jspx_fnmap_0));
  ...
  private boolean _jspx_meth_c_set_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_c_set_2.setVar("orderDate");
    _jspx_th_c_set_2.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${order.orderDate}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_set_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_c_set_3.setVar("formattedTime");
    _jspx_th_c_set_3.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${fn:substring(orderDate, 11, 19)}", java.lang.Object.class, (PageContext)_jspx_page_context, _jspx_fnmap_0));
  ...
  private boolean _jspx_meth_fmt_formatNumber_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_fmt_formatNumber_0.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${order.total}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_when_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_0, PageContext _jspx_page_context)
    ...
    _jspx_th_c_when_0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${not empty customerName}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_if_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_0, PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag > 1}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_if_1 = _jspx_th_c_if_1.doStartTag();
    if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("                                                <li class=\"page-item\">\n");
        out.write("                                                    <a class=\"page-link\" href=\"ManagerOrderSearchByCustomerNameController?customerName=");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${customerName}", java.lang.String.class, (PageContext)_jspx_page_context, null));
        out.write("&index=");
  ...
  private boolean _jspx_meth_c_set_4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_0, PageContext _jspx_page_context)
    ...
    _jspx_th_c_set_4.setVar("startPage");
    _jspx_th_c_set_4.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag - 1 < 1 ? 1 : tag - 1}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_set_5(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_0, PageContext _jspx_page_context)
    ...
    _jspx_th_c_set_5.setVar("lastPage");
    _jspx_th_c_set_5.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag + 1 > endPage ? endPage : tag + 1}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_forEach_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_0, PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_2.setBegin(((java.lang.Integer) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${startPage}", java.lang.Integer.class, (PageContext)_jspx_page_context, null)).intValue());
    _jspx_th_c_forEach_2.setEnd(((java.lang.Integer) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${lastPage}", java.lang.Integer.class, (PageContext)_jspx_page_context, null)).intValue());
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\" href=\"ManagerOrderSearchByCustomerNameController?customerName=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${customerName}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("&index=");
  ...
  private boolean _jspx_meth_c_if_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_0, PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag < endPage}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_when_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_0, PageContext _jspx_page_context)
    ...
    _jspx_th_c_when_1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${not empty startDate}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    ...
    if (_jspx_eval_c_when_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("\n");
        out.write("                                            ");
        if (_jspx_meth_c_if_4((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_when_1, _jspx_page_context))
          return true;
        out.write("\n");
        out.write("                                        ");
  ...
  private boolean _jspx_meth_c_if_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_1, PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_3.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag > 1}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_if_3 = _jspx_th_c_if_3.doStartTag();
    if (_jspx_eval_c_if_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("                                                <li class=\"page-item\">\n");
        out.write("                                                    <a class=\"page-link\" href=\"ManagerOrderSearchByDateController?startDate=");
  ...
  private boolean _jspx_meth_c_forEach_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_1, PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_3.setBegin(((java.lang.Integer) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag - 1 < 1 ? 1 : tag - 1}", java.lang.Integer.class, (PageContext)_jspx_page_context, null)).intValue());
    _jspx_th_c_forEach_3.setEnd(((java.lang.Integer) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag + 1 > endPage ? endPage : tag + 1}", java.lang.Integer.class, (PageContext)_jspx_page_context, null)).intValue());
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("                                                    <a class=\"page-link ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag == i ? 'active__page' : ''}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" href=\"ManagerOrderSearchByDateController?startDate=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${startDate}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("&endDate=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${endDate}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("&index=");
  ...
  private boolean _jspx_meth_c_if_4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_1, PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_4.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag < endPage}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_when_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_0, PageContext _jspx_page_context)
    ...
    _jspx_th_c_when_2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${not empty OrderStatus}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    ...
    if (_jspx_eval_c_when_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("\n");
        out.write("                                            ");
        if (_jspx_meth_c_if_6((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_when_2, _jspx_page_context))
          return true;
        out.write("\n");
        out.write("                                        ");
  ...
  private boolean _jspx_meth_c_if_5(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_2, PageContext _jspx_page_context)
    ...
    if (_jspx_eval_c_if_5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("                                                <li class=\"page-item\">\n");
        out.write("                                                    <a class=\"page-link\" href=\"ManagerOrderSearchByOrderStatusController?status=");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${OrderStatus}", java.lang.String.class, (PageContext)_jspx_page_context, null));
        out.write("&index=");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag - 1}", java.lang.String.class, (PageContext)_jspx_page_context, null));
        out.write("\">\n");
        out.write("                                                        <i class=\"fa-solid fa-chevron-left\"></i>\n");
  ...
  private boolean _jspx_meth_c_forEach_4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_2, PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_4.setBegin(((java.lang.Integer) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag - 1 < 1 ? 1 : tag - 1}", java.lang.Integer.class, (PageContext)_jspx_page_context, null)).intValue());
    _jspx_th_c_forEach_4.setEnd(((java.lang.Integer) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag + 1 > endPage ? endPage : tag + 1}", java.lang.Integer.class, (PageContext)_jspx_page_context, null)).intValue());
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("                                                    <a class=\"page-link ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag == i ? 'active__page' : ''}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" href=\"ManagerOrderSearchByOrderStatusController?status=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${OrderStatus}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("&index=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${i}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write('"');
  ...
  private boolean _jspx_meth_c_if_6(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_2, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  c:if
    ...
    _jspx_th_c_if_6.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_when_2);
    _jspx_th_c_if_6.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag < endPage}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_if_7(javax.servlet.jsp.tagext.JspTag _jspx_th_c_otherwise_0, PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_7.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag > 1}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_if_7 = _jspx_th_c_if_7.doStartTag();
    if (_jspx_eval_c_if_7 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("                                                <li class=\"page-item\">\n");
        out.write("                                                    <a class=\"page-link\" href=\"ManagerOrderManageController?index=");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag - 1}", java.lang.String.class, (PageContext)_jspx_page_context, null));
        out.write("\">\n");
        out.write("                                                        <i class=\"fa-solid fa-chevron-left\"></i>\n");
        out.write("                                                    </a>\n");
  ...
  private boolean _jspx_meth_c_set_6(javax.servlet.jsp.tagext.JspTag _jspx_th_c_otherwise_0, PageContext _jspx_page_context)
    ...
    _jspx_th_c_set_6.setVar("startPage");
    _jspx_th_c_set_6.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag - 1 < 1 ? 1 : tag - 1}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_set_7(javax.servlet.jsp.tagext.JspTag _jspx_th_c_otherwise_0, PageContext _jspx_page_context)
    ...
    _jspx_th_c_set_7.setVar("lastPage");
    _jspx_th_c_set_7.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag + 1 > endPage ? endPage : tag + 1}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_forEach_5(javax.servlet.jsp.tagext.JspTag _jspx_th_c_otherwise_0, PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_5.setBegin(((java.lang.Integer) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${startPage}", java.lang.Integer.class, (PageContext)_jspx_page_context, null)).intValue());
    _jspx_th_c_forEach_5.setEnd(((java.lang.Integer) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${lastPage}", java.lang.Integer.class, (PageContext)_jspx_page_context, null)).intValue());
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("                                                    <a class=\"page-link ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag == i ? 'active__page' : ''}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" href=\"ManagerOrderManageController?index=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${i}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write('"');
          out.write('>');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${i}", java.lang.String.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_if_8(javax.servlet.jsp.tagext.JspTag _jspx_th_c_otherwise_0, PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_8.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${tag < endPage}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_if_9(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_9.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${toastMessage != null}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_if_9 = _jspx_th_c_if_9.doStartTag();
    if (_jspx_eval_c_if_9 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write(" \n");
        out.write("        <div id=\"toast\" style=\"z-index: 10\">  \n");
        out.write("            <div class=\"toast_main row ");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${toastMessage.equals('success') ? 'toast--success' : 'toast--error' }", java.lang.String.class, (PageContext)_jspx_page_context, null));
        out.write("\" style=\"display:flex\">\n");
        out.write("                <div class=\"toast__icon\">\n");
        out.write("                    <i class=\"fa-solid ");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${toastMessage.equals('success') ? 'fa-circle-check' : 'fa-times-circle' }", java.lang.String.class, (PageContext)_jspx_page_context, null));
        out.write("\"></i>\n");
        out.write("                </div>\n");
        out.write("                <div class=\"toast_body\">\n");
        out.write("                    <h3 class=\"toast__title\">");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${toastMessage.equals('success') ? 'Success' : 'Error' }", java.lang.String.class, (PageContext)_jspx_page_context, null));
        out.write("</h3>\n");
        out.write("                    <p class=\"toast__msg\">");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${message}", java.lang.String.class, (PageContext)_jspx_page_context, null));
        out.write("</p>\n");
        out.write("                </div>\n");
        out.write("                <div class=\"toast__close\">\n");
