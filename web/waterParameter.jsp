            ...
            <div class="waterParameter_item_stand col_custom  col-md-6  ">
                <div class="water-parameter-item">
                    <div class="water-item-detail">
                        ...
                        <div class="item__component d-flex justify-content-between">
                            <div class="item_s">
                                <div class="item_name-value pr-2">Nitrite(NO<sub>2</sub>):</div>
                            ...
                            <div class="item_s">
                                <div class="item_name-value pr-2">Oxygen(O<sub>2</sub>):</div>
                                <div class="item_value">
                                    <span class="value_water-parameter" data-param="O2">0.21</span>  
                                    <span class="unit_value">mg/l</span> 
                                </div>
                            </div>
                        </div>
                        <div class="item__component d-flex justify-content-between">
                            <div class="item_s">
                                <div class="item_name-value pr-2">Nitrate(NO<sub>3</sub>):</div>
                                <div class="item_value">
                                    <span class="value_water-parameter">0.21</span>  
                                    <span class="unit_value">mg/l</span>
                                </div>
                            </div>
                            <div class="item_s">
                                <div class="item_name-value pr-2">Temperature:</div>
                                <div class="item_value">
                                    <span class="value_water-parameter">0.21</span>  
                        ...
                        <div class="item__component d-flex justify-content-between">
                            <div class="item_s">
                                <div class="item_name-value pr-2">Phosphate(PO<sub>4</sub>):</div>
                                <div class="item_value">
                                    <span class="value_water-parameter">0.21</span>  
                                    <span class="unit_value">mg/l</span>
                                </div>
                            ...
                            <div class="item_s">
                                <div class="item_name-value pr-2">pH-Value:</div>
                                <div class="item_value">
                                    <span class="value_water-parameter">1</span>  
                                    <span class="unit_value"></span> 
                                </div>
                            </div>
                        </div>
                        <div class="item__component d-flex justify-content-between">
                            <div class="item_s">
                                <div class="item_name-value pr-2">Ammonium(NH<sub>4</sub>):</div>
                                <div class="item_value">
                                    <span class="value_water-parameter">0.21</span>  
                                    <span class="unit_value">mg/l</span>
                                </div>
                            ...
                            <div class="item_s">
                                <div class="item_name-value pr-2">KH:</div>
                                <div class="item_value">
                                    <span class="value_water-parameter">0.21</span>  
                                    <span class="unit_value">°dH</span> 
                                </div>
                            </div>
                        </div>
                        <div class="item__component d-flex justify-content-between">
                            <div class="item_s">
                                <div class="item_name-value pr-2">Hardness:</div>
                                <div class="item_value">
                                    <span class="value_water-parameter">0.21</span>  
                                    <span class="unit_value">°dH</span>
                                </div>
                            ...
                            <div class="item_s">
                                <div class="item_name-value pr-2">CO2:</div>
                                <div class="item_value">
                                    <span class="value_water-parameter">0.21</span>  
                                    <span class="unit_value">mg/l</span> 
                                </div>
                        ...
                        <div class="item__component d-flex justify-content-between">
                            <div class="item_s">
                                <div class="item_name-value pr-2">Salt:</div>
                                <div class="item_value">
                                    <span class="value_water-parameter">0.21</span>  
                                    <span class="unit_value">%</span>
                                </div>
                            ...
                            <div class="item_s">
                                <div class="item_name-value pr-2">Amount fed:</div>
                                <div class="item_value">
                                    <span class="value_water-parameter">34</span>  
                                    <span class="unit_value">g</span>
                                 </div>
                            </div>
                        </div>
                        <div class="item__component d-flex justify-content-between">
                            <div class="item_s">
                                <div class="item_name-value pr-2">Outdoor temp:</div>
                                <div class="item_value">
                                    <span class="value_water-parameter">15.5</span>  
                                    <span class="unit_value">℃</span>
                                </div>
                            </div>
                            <div class="item_s">
                                <!-- <div class="item_name-value pr-2">Amount fed:</div> -->
                                <!-- <div class="item_value">34 <span class="unit_value">g</span> </div> -->
                            </div>
                        </div>
