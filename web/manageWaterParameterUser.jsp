<%-- 
    Document   : manageWaterParameterUser
    Created on : 26/10/2024, 2:25:44 PM
    Author     : PC
--%>
...
<html lang="en"> 
    <head>
        ...
        <title>Manage Water Parameter</title>
        ...
        <div class="container_admin">
            <div id="db-wrapper">
                ...
                <div class="right-navbar-admin-manage"> 
                    ...
                    <div class="content">
                        <div class="header">
                            <h2>Manage Account Water Parameter List</h2>
                            <div class="actions"> 
                            </div>
                        </div>
                        <div class="table-container" id="userTableContainer">
                                    ...
                                    <c:if test="${not empty listAcc}">
                                        ...
                                        <c:forEach var="account" items="${listAcc}">
                                            <tr>
                                                ...
                                                <td>
                                            <button class="edit-btn" onclick="window.location.href='ManagerWaterParameterController?acid=${account.userID}'">
                            ...
                            <div class="footer">
                                <ul class="pagination">
                                    ...
                                    <c:if test="${tag > 1}">
                                        <li class="page-item">
                                            <a href="ManagerWaterParameterController?index=${tag-1}" class="page-link text-dark">
                                    ...
                                    <c:forEach var="i" begin="1" end="${endPage}" step="1">
                                        <c:if test="${i <= 3 || i >= endPage - 2 || (i >= tag - 1 && i <= tag + 1)}">
                                            <li class="page-item ${tag == i ? 'active' : ''}">
                                                <a href="ManagerWaterParameterController?index=${i}" class="page-link text-dark ${tag == i ? 'active__page' : ''}">
                                                    ${i}
                                                </a>
                                            </li>
                                        </c:if>
