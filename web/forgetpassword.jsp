<%-- 
    Document   : fogertpassword
    Created on : Oct 21, 2024, 9:06:49 PM
    Author     : ASUS
--%>
    ...
    <body>
        <div class="main_container_create">
            ...
            <div class="form-create_pw"> 
                <form action="ForgetPasswordController" method="post" class="form" id="form-1">
                    <p class="form-title">Change your password with email</p>
                    <div class="input-container form-group">
                        <input type="email" name="email" placeholder="Your email" required>
                    </div>
                    <c:if test="${not empty mailError}">
                        <p class="error-message" style="color: red;">${mailError}</p>
                    </c:if>
                    <div class="input-container form-group">
                    ...
                    <button type="submit" class="submit mt-4">Confirm</button>
                </form>
            </div>
        </div>
        <style>
