    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (acc != null) { 
            if (acc.getUserRole().equalsIgnoreCase("admin")) {
                res.sendRedirect("MainController?action=" + IConstant.DASHBOARD_ADMIN);
            } else if (acc.getUserRole().equalsIgnoreCase("manager")) {
                res.sendRedirect("MainController?action=" + IConstant.DASHBOARD_MANAGER);
            }else{
                res.sendRedirect("MainController?action="+ IConstant.HOME);
            }
        } else {
