...
//    }
    ...
    public ArrayList<Blog> getAllBlogs(int index){
        ...
        try {
            c = DatabaseConnectionManager.getConnection();
            if (c != null) {
                String sql = "select b.BlogID, b.AccID, acc.UserImage, acc.KoiCareID, b.BlogsDate, b.BlogsImage, b.Title, b.Content, b.IDBlogCate, ctb.NameBlogCate \n" +
                                "from [dbo].[Blogs] b \n" +
                ...
                if (rs != null) {
                    while (rs.next()) {
                        ...
                        acc.setProfileImage(rs.getString(3));
                        acc.setKoiCareID(rs.getString(4));
